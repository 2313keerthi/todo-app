async function getTask() {
  ...
  let data = await fetch(
    "https://api.todoist.com/rest/v2/tasks?project_id=2329941246&search=",
    {
      method: "GET",
      headers: {
...
document.getElementById("searchInput").addEventListener("input", function () {
  ...
  taskBoxes.forEach(function (taskBox) {
    ...
    if (
      taskContent.includes(searchText) ||
      (dueDate && dueDate.textContent.toLowerCase().includes(searchText))
    ) {
